...
import profileDeault from "@/assets/images/profile.png"
                    ...
                    {session && (
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0">
                            ...
                            <Link href="/messages" className="relative group">
                                ...
                                <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold bg-red-600 text-white rounded-full transform translate-x-1/2 -translate-y-1/2">
                                    2
                                </span>
                            </Link>
                            ...
                            <div className="relative ml-3">
                                ...
                                >
                                    ...
                                    <Image
                                        ...
                                        src={profileImage || profileDeault}
                                        width={40}
                                        height={40}
                                        alt=""
                                    />
